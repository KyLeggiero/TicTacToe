...
/* Plays Tic Tac Toe, with 2 computer players
 * 
 * Version: 3.0.0
...
public class TicTacToeComp2
{
  public static void main(String[] args)
  {
    ...
    while (true)
    {
      System.out.println ("What is Computer 1's mark?");
      mark1 = scan.next();
    ...
    while (true)
    {
      System.out.println ("What is Computer 2's mark?");
      mark2 = scan.next();
        ...
        if (move)
        {
          ...
          if (!blocked)
          {
            for (int i=0; i < (size * size); i++)
            {
              ...
              if (xo[size / 2][size / 2] != mark2 && xo[size / 2][size / 2] != mark1)
              {
                xo[size / 2][size / 2] = mark1;
                break;
              }
              
              else if (xo[rand1][rand2] != mark2 && xo[rand1][rand2] != mark1)
              {
                xo[rand1][rand2] = mark1;
                break;
              }
            }
          }
